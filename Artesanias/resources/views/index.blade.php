...
<body>
    ...
    <div class="container" id="seccion1">
        <div class="row">
            <div class="col-5 cuadro" style="background-color: red;">1</div>
            <div class="col cuadro">2</div>
            <div class="col cuadro">3</div>
            <div class="col cuadro">4</div>
        </div>
        <div class="row">
            <div class="col cuadro" style="background-color: red;">1</div>
            <div class="col cuadro">2</div>
            <div class="col cuadro">3</div>
            <div class="col cuadro">4</div>
        </div>
